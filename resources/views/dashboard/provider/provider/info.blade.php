        ...
        <form method="POST" action="{{ route('shop.store') }}">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" placeholder="Shoppyfystacia" name="name">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Monto minimo</label>
                    <input type="text" class="form-control" id="inputPassword4" placeholder="1300000" aria-describedby="montoMinimo"
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputAddress2" placeholder="+584169856239" name="phone">
                </div>
            </div>

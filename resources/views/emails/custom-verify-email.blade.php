                            ...
                            <td>
                                <div align="center"
                                    ...
                                    <div
                                        ...
                                        Gracias para elegir {{ config('app.name') }} ahora puede comenzar a adquirir tus
                                        productos.<br><br><span style="font-weight: 700;">¡Muchas gracias por
                                            registrarte en {{ config('app.name') }}!</span><br><br>
                                        Para configurar tu cuenta, confirma tu dirección de correo electrónico haciendo
                                        ...
                                        <div style="padding-top:32px;text-align:center">
                                            <a href="{{ $url }}"
                                                ...
                                                target="_blank" data-saferedirecturl="{{ $url }}">
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 13px; margin-top: 15px; margin-bottom: 10px;">¿No
                                                funciona el botón? Prueba con este enlace:</p>
                                            <a href="{{ $url }}" style="color: #094c7b;">
                                                {{ $url }}
                                            </a>
                                        </div>
                                    </div>

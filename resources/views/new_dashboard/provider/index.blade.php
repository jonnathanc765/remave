    ...
    <div class="ecommerce-widget">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="text-muted text-truncate">Promedio del total por Orden</h5>
                        <div class="metric-value d-inline-block">
                            <h1 class="mb-1">${{ round($avg->avg(), 0) }}</h1>
                        </div>
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $order->code }}</td>
                                        <td>
                                            <a href="{{ route('provider.orders.show', ['id' => $order->id]) }}">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    <td colspan="9">{{-- <a href="{{ route('orders.index') }}"
                                            class="btn btn-outline-light float-right">Ver Detalles</a> --}}
                                    </td>
                                    </tr>
                                </tbody>
                            </table>
...
<script>
    $("#sparkline-revenue").sparkline(@json($lastMonthRevenue), {
        type: 'line',
        width: '99.5%',
        height: '100',
        lineColor: '#5969ff',
    ...
    $("#sparkline-revenue2").sparkline(@json($lastYearRevenue), {
        type: 'line',
        width: '99.5%',
        height: '100',
        lineColor: '#ff407b',
    ...
    $("#sparkline-revenue3").sparkline(@json($sellProductsInLastMonth), {
        type: 'line',
        width: '99.5%',
        height: '100',
        lineColor: '#25d5f2',
    ...
    $("#sparkline-revenue4").sparkline(@json($avg), {
        type: 'line',
        width: '99.5%',
        height: '100',
        lineColor: '#fec957',
